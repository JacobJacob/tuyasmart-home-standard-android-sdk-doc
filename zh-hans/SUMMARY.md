...
* [用户管理](./resource/User.md)
  ...
  * [修改用户信息](./resource/User_Loginout.md)
  * [登出](./resource/User_Loginout.md#退出登录接口)
  * [停用帐号](./resource/User_Loginout.md#停用账户)
...
* [设备配网](./resource/Activator_wifi.md)
  * [快连(EZ)模式](./resource/Activator_wifi.md#ez模式配网)
  * [热点(AP)模式](./resource/Activator_wifi.md#ap模式配网)
...
* 设备控制
    ...
    * [修改设备名称](./resource/Device_modify.md#设备重命名)
    * [移除设备](./resource/Device_modify.md#移除设备)
    * [查询WiFi信号强度](./resource/Device_modify.md#查询wifi信号强度)
    * [DeviceBean数据模型](./resource/Device_modify.md#devicebean数据模型)
...
* [群组管理](./resource/Group.md)
    * [Wifi群组](./resource/Group_wifi.md)
    * [Zigbee群组](./resource/Group_zigbee.md)
    * [群组控制](./resource/Group_control.md)
    
* [智能场景](./resource/SmartScene_Manager.md)
    * [智能场景](./resource/SmartScene_Manager.md#智能)
