...
import com.tuya.smart.android.demo.device.standard.StandardCommonDebugDeviceAdapter;
import com.tuya.smart.android.demo.device.standard.StandardCommonDeviceDebugPresenter;
 ...
 */
public class CommonStandardDeviceDebugActivity extends BaseActivity implements ICommonDeviceDebugView {

    private StandardCommonDebugDeviceAdapter mCommonDebugDeviceAdapter;
    @BindView(R.id.lv_dp_list)
    public ListView mDpListView;
    private StandardCommonDeviceDebugPresenter mPresenter;
    ...
    private void initPresenter() {
        mPresenter = new StandardCommonDeviceDebugPresenter(this, this);
    }
    ...
    private void initAdapter() {
        List<StandardSchemaBean> standardSchemaBeans = new ArrayList<StandardSchemaBean>();
        mCommonDebugDeviceAdapter = new StandardCommonDebugDeviceAdapter(this, mPresenter.getDevBean(), R.layout.list_view_common_debug, standardSchemaBeans);
    ...
    public void updateView(String dpStr) {
        ...
        for (Map.Entry<String, Object> entry : jsonObject.entrySet()) {
            List<StandardSchemaBean> data = mCommonDebugDeviceAdapter.getData();
            for (int i = 0;i< data.size();i++){
                Set<String> keySet = jsonObject.keySet();

                for (String key : keySet){
                    if (data.get(i).getDpCode().equals(key)){
                        data.get(i).setValue(jsonObject.get(key));
                    }
                }
            }
            mCommonDebugDeviceAdapter.setData(data);
