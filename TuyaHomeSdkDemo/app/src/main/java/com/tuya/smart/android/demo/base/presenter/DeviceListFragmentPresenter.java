...
import com.tuya.smart.android.demo.device.CommonStandardDeviceDebugActivity;
...
//                                //重置说明
    ...
    private void gotoDeviceCommonActivity(DeviceBean devBean) {
        Intent intent = new Intent(mActivity, CommonStandardDeviceDebugActivity.class);
        intent.putExtra(CommonDeviceDebugPresenter.INTENT_DEVID, devBean.getDevId());
        mActivity.startActivity(intent);
    }

    public void getDataFromServer() {
        final long homeId = FamilyManager.getInstance().getCurrentHomeId();
